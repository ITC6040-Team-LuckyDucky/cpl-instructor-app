...
def get_system_prompt(stage, collected_data=None, document_context=None):
    ...
    STYLE = (
        ...
        "CRITICAL: Every single response MUST end with a direct question the student can answer. No exceptions. "
        "Never end with a transitional statement like 'Let's move on' or 'Thanks for sharing' without an actual question after it. "
        "BAD endings: 'Let's move on to the next topic.' / 'Thanks for sharing that.' / 'I'll refer to your document as we go.' "
        "GOOD endings: 'Got it.\n\nDo you have any documents like certificates or work samples you can upload?' / 'Thanks for sharing.\n\nCan you give me a specific example of how you used [concept]?' "
        "If you have enough information for the current topic, skip immediately to asking the first question of the next topic — do not announce the transition. "
    ...
    prompts = {
        ...
        "experience": (
            ...
            + (
                ...
                f"Read the documents and identify the most relevant role or project for {course}. "
                "When referencing the student's background, use ONE short identifying phrase — just the company name and project name. "
                "Do NOT quote or paraphrase descriptions from the document. "
                "For example, say 'your work at Webcomm Technology on the banking project' — NOT 'you delivered enterprise banking solutions and led API integration initiatives with banking partners.' The student already knows what they did. "
                "Only reference facts that are explicitly stated in the documents. Never infer — do not use 'likely', 'probably', 'presumably', or 'which may have involved'. If something isn't stated directly, ask the student about it instead of guessing. "
        ...
        "skills_reflection": (
            ...
            + (
                ...
                "For example, say 'your work at Webcomm Technology on the banking project' — NOT 'you delivered enterprise banking solutions and led API integration initiatives with banking partners.' The student already knows what they did. "
                "Only reference facts that are explicitly stated in the documents. Never infer — do not use 'likely', 'probably', 'presumably', or 'which may have involved'. If something isn't stated directly, ask the student about it instead of guessing. "
                f"Then ask ONE simple focused question like: 'In your work at [Company] on [Project], can you walk me through how you used [concept]?' "
